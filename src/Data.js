...
import { SiC, SiAlgorithms } from 'react-icons/si';
 ...
 export const topics = [
  ...
  },
  {
    id: 'python',
    name: 'Python',
    icon: "FaPython" ,  // Python Icon from React Icons
  },
  {
    id: 'java',
    name: 'Java',
  ...
  },
  {
    id: 'dsa',
    name: 'DSA',
    icon: "SiAlgorithms",  // Algorithms Icon from React Icons
  },
  {
    id: 'c',
    name: 'C ',
...
export const Freecourse= [
  {
    ...
    "description": "Learn the fundamentals of operating systems, including process management, memory management, and file systems.",
  ...
  },
  {
    ...
    "description": "A comprehensive guide to HTML, covering basic tags, attributes, and structuring web pages.",
  ...
  },
  {
    ...
    "description": "An introductory course on CSS, including styling techniques, layout designs, and responsive design.",
  ...
  {
    "title": "Master in php",
    "description": "Learn C programming from scratch, including syntax, data structures, and algorithms.",
  ...
  },
  {
    ...
    "description": "Understand the concepts of Database Management Systems, including database design, normalization, and SQL.",
  ...
  },
  {
    ...
    "description": "Get started with JavaScript, covering basic syntax, operators, functions, and DOM manipulation.",
  ...
  },
  {
    ...
    "description": "An introduction to machine learning concepts, including supervised and unsupervised learning, and basic algorithms.",
  ...
  },
  {
    ...
    "description": "Learn how to use and build applications with ChatGPT, including API integration and prompt engineering.",
  ...
  },
  {
    ...
    "description": "A course on prompt engineering for AI models, focusing on crafting effective prompts and improving model outputs.",
